        ...
        if (envSampler && envSamplerArg) {
            if (envSampler === RATE_LIMITED_SAMPLER || envSampler === FIXED_PERCENTAGE_SAMPLER) {
                ...
                if (isNaN(argValue) || argValue < 0) {
                    index_js_1.Logger.getInstance().warn("Invalid value for OTEL_TRACES_SAMPLER_ARG. It should be a non-negative number.");
                }
                else {
            ...
            // Not supported sampler
                ...
                index_js_1.Logger.getInstance().warn(`Unsupported value for OTEL_TRACES_SAMPLER: ${envSampler}. Supported values are: ${RATE_LIMITED_SAMPLER}, ${FIXED_PERCENTAGE_SAMPLER}.`);
            }
        }
    }
}
